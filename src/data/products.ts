    ...
    variantGroups: [
      {
        ...
        label: "Thời hạn",
        options: [
          { id: "v1-1", name: "1 tháng", priceModifier: 0, stock: 100, inStock: true },
          { id: "v1-2", name: "3 tháng", priceModifier: 5000, stock: 80, inStock: true },
          { id: "v1-3", name: "6 tháng", priceModifier: 15000, stock: 50, inStock: true },
        ],
      },
    ],
  },
    ...
    variantGroups: [
      {
        ...
        label: "Gói",
        options: [
          { id: "v2-1", name: "1 tháng", priceModifier: 0, stock: 200, inStock: true },
          { id: "v2-2", name: "3 tháng", priceModifier: 10000, stock: 150, inStock: true },
        ],
      },
    ],
  },
    ...
    variantGroups: [
      {
        ...
        label: "Thời hạn",
        options: [
          { id: "v3-1", name: "1 tháng", priceModifier: 0, stock: 90, inStock: true },
          { id: "v3-2", name: "6 tháng", priceModifier: 20000, stock: 60, inStock: true },
        ],
      },
    ],
  },
    ...
    variantGroups: [
      {
        ...
        label: "Gói",
        options: [
          { id: "v4-1", name: "1 năm", priceModifier: 0, stock: 100, inStock: true },
          { id: "v4-2", name: "2 năm", priceModifier: 50000, stock: 50, inStock: true },
        ],
      },
    ],
  },
    ...
    variantGroups: [
      {
        ...
        label: "Thời hạn",
        options: [
          { id: "v5-1", name: "1 tháng", priceModifier: 0, stock: 80, inStock: true },
          { id: "v5-2", name: "3 tháng", priceModifier: 30000, stock: 40, inStock: true },
        ],
      },
    ],
  },
    ...
    variantGroups: [
      {
        ...
        label: "Thời hạn",
        options: [
          { id: "v6-1", name: "1 tháng", priceModifier: 0, stock: 120, inStock: true },
          { id: "v6-2", name: "3 tháng", priceModifier: 50000, stock: 70, inStock: true },
        ],
      },
    ],
  },
    ...
    variantGroups: [
      {
        ...
        label: "Thời hạn",
        options: [
          { id: "v7-1", name: "1 tháng", priceModifier: 0, stock: 90, inStock: true },
          { id: "v7-2", name: "1 năm", priceModifier: 50000, stock: 30, inStock: true },
        ],
      },
    ],
  },
