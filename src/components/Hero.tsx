                                ...
                                {categoriesWithIcons.map((cat, index) => (
                                    ...
                                    >
                                        <Link
                                            ...
                                            className="flex items-center gap-4 px-5 py-3.5 hover:bg-gray-50 text-black hover:text-teal-600 transition group"
                                        >
                                            {/* Màu icon đậm hơn */}
                                            <div className="text-gray-700 group-hover:text-teal-600 transition flex items-center justify-center shrink-0 w-5 h-5">
                                                {cat.icon()}
                                            </div>
                                            {/* font-semibold giúp chữ đậm hơn */}
