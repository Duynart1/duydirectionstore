...
export default function CategoryPage() {
  ...
  const currentCategoryName = categoryMap[slug] || "Tất cả sản phẩm";
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      if (categoryMap[slug]) {
        query = query.eq("category", categoryMap[slug]);
      }
    ...
    <div className="bg-[#f3f4f6] min-h-screen py-8">
      <div className="container mx-auto max-w-[1200px] px-4">
        ...
        <div className="text-sm text-gray-500 mb-6 flex gap-2 items-center">
          ...
          <span>/</span>
          <a href="/danh-muc" className="hover:text-teal-600 transition">Danh mục</a>
          <span>/</span>
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          {/* SIDEBAR BÊN TRÁI - Đã dùng thẻ <a> để click mượt mà */}
          <div className="w-full md:w-[250px] shrink-0">
            <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden sticky top-4">
              ...
              <ul className="py-2 text-sm text-gray-700">
                <li>
                  <a href="/danh-muc" className="block px-5 py-3 hover:bg-gray-50 transition border-l-4 border-transparent">
                    Tất cả sản phẩm
                  </a>
                </li>
                  ...
                  return (
                    <li key={cat.slug}>
                      <a
                        ...
                        className={`block px-5 py-3 hover:bg-gray-50 transition border-l-4 ${isActive ? 'bg-purple-50 text-purple-700 font-bold border-purple-600' : 'border-transparent'}`}
                      >
                        {cat.name}
                      </a>
                    </li>
          ...
          <div className="flex-1">
            <div className="flex justify-between items-center mb-6">
              <h1 className="text-2xl font-bold text-gray-800 capitalize">{currentCategoryName}</h1>
            ...
            {loading ? (
              ...
              <div className="py-20 text-center text-gray-500 bg-white rounded-lg border border-gray-100">Không có sản phẩm nào trong danh mục này.</div>
            ) : (
            ...
            {/* Văn bản chuẩn SEO */}
            <div className="bg-white rounded-lg p-6 border border-gray-100 text-sm text-gray-600 leading-relaxed shadow-sm">
              <h3 className="font-bold text-gray-800 mb-3">Bạn đang tìm kiếm trải nghiệm {currentCategoryName.toLowerCase()} không giới hạn?</h3>
              <p className="mb-3">Tại ShopTaikhoanVN, chúng tôi cung cấp các giải pháp tài khoản Premium chính chủ, giúp bạn tận hưởng kho nội dung khổng lồ với mức giá tiết kiệm đến 70%.</p>
            </div>
          </div>
        </div>
      </div>
